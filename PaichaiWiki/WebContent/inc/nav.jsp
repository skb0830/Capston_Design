    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-0">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 row" id="navbar">
          ...
          <div class="nav-item d-xl-none ps-3 d-flex align-items-center col-sm-2">
          ...
          <div class="ms-md-auto pe-md-5 d-flex flex-row-reverse align-items-center col-2 col-sm-2">
