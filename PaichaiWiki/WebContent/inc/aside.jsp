      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">문의사항</span>
          </a>
        </li>
        <!-- 
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="https://www.pcu.ac.kr/kor" target='_blank'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">배재대학교 홈페이지</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="http://www.paichai.news/" target='_blank'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">배재신문</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="https://nasum.pcu.ac.kr/" target='_blank'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">배재대학교 나섬</span>
          </a>
        </li>
      </ul>
    </div>
